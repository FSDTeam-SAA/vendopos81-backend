...
export const getNotificationByCustomerId = catchAsync(async (req: Request, res: Response) => {
...
export const getNotificationBySupplierId = catchAsync(async (req: Request, res: Response) => {
  const { userId } = req.params;
  ...
  if (supplier.isSuspended) {
    throw new AppError('Your supplier account is suspended', httpStatus.FORBIDDEN);
  }
...
export const getNotificationByAdminId = catchAsync(async (req: Request, res: Response) => {
  const { userId } = req.params;
